...
a=st.number_input("Enter the number of Cylinders in cc",0,10000)
b=st.number_input("Enter the Displacement in cc",0,10000)
c=st.number_input("Enter the Horsepower in ps",100,50000)
d=st.number_input("Enter the Weight in Kg",200,10000)
