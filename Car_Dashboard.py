...
st.text('1. Toyota seemed to be favored car company.')
st.text('2. Number of gas fueled cars are more than `diesel`.')
st.text('3. sedan is the top car type prefered.')
st.write('')
st.write('')
st.write('')
...
st.text('1. doornumber variable is not affacting the price much. There is no sugnificant')
...
plt.show()
st.write(fig7)
st.text('2. It seems aspiration with turbo have higher price range than the std (though it')
